...
TERM -> (EXPRESSION) | !EXPRESSION | APPLIED_PREDICATE | for every ID ID (EXPRESSION) | there is a ID ID (EXPRESSION) | for every ID ID except ID (EXPRESSION) | there is a ID ID except ID (EXPRESSION)
...
include::novasintaxe/lady1.txt[indent=4]
...
include::novasintaxe/lady2.txt[indent=4]
...
include::novasintaxe/lady3.txt[indent=4]
...
include::novasintaxe/lady4.txt[indent=4]
...
include::novasintaxe/lady5.txt[indent=4]
...
include::novasintaxe/lady6.txt[indent=4]
...
include::novasintaxe/lady7.txt[indent=4]
...
include::novasintaxe/lady8.txt[indent=4]
...
include::novasintaxe/lady9.txt[indent=4]
...
include::novasintaxe/lady10.txt[indent=4]
...
include::novasintaxe/lady11.txt[indent=4]
